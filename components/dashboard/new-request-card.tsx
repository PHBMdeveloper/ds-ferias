...
export function NewRequestCardClient({
  ...
  return (
    ...
    >
      ...
      {/* REGRAS CLT */}
      <details className="group rounded-lg border border-[#e2e8f0] bg-[#f5f6f8] dark:border-[#252a35] dark:bg-[#0f1117]" open>
        <summary className="flex cursor-pointer items-center justify-between px-6 py-4 text-xl font-bold text-[#1a1d23] hover:bg-[#ebedf0] dark:text-white dark:hover:bg-[#1e2330]">
          Regras CLT
          <svg
        ...
        <div className="border-t border-[#e2e8f0] p-6 dark:border-[#252a35]">
      ...
      <div className="space-y-2">
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          <div className="space-y-1">
            <label className="block text-base font-medium text-[#475569] dark:text-slate-300">Início</label>
            <DatePicker
          ...
          <div className="space-y-1">
            <label className="block text-base font-medium text-[#475569] dark:text-slate-300">Término</label>
            <DatePicker
